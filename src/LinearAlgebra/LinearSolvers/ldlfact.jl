...
"""
mutable struct LDLFactLinearSolver{Tv<:Real, Ta<:SparseMatrixCSC{Tv, <:Integer}} <: IndefLinearSolver{Tv, Ta}
    ...
    function LDLFactLinearSolver(A::SparseMatrixCSC{Tv, Int}) where{Tv<:Real}
        m, n = size(A)
        θ = ones(Tv, n)
